//
//  MGLastUsageController.m
//  Data Robot
//
//  Created by Dan Park on 7/4/13.
...
#import "MGLastUsageController.h"
...
@interface MGLastUsageController (PadProtocols)
<MGQuotaPadProtocol, MGDayPadProtocol, MGUsedDataPadProtocol>
@end

@interface MGLastUsageController () <UIAlertViewDelegate>
{
...
@implementation MGLastUsageController
...
#define Repeat_Animation 2
    ...
    CGFloat finalLevel = 0.1;
    NSTimeInterval duration = 1.5;//1.5
    NSTimeInterval delay = 2.0;//2.0
...
//                         NSNumber *number = [billPeriod adjustedDataUsageInMB];
//                         NSUInteger adjustedDataUsageInMB = [number unsignedIntegerValue];
//                         [content updateValue:adjustedDataUsageInMB];
                     }];
}
